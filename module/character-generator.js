...
export const createActorWithCharacter = async (characterData) => {
  ...
  return EternalHungerActor.create(data);
};
...
/**
 * @param {Object} items
 @return {Promise<EternalHungerItem[]>}
 */
...
/**
 * @param {Object} items
 * @returns {Promise.<EternalHungerItem[]>}
 */
...
export const generateCharacter = async () => {
  ...
  const characterGenerator = EternalHunger.characterGenerator;
